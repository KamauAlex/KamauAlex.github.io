			...
			>
				<div className='flex flex-col space-y-8 justify-center items-center'>
					<div className='flex flex-col justify-center items-center space-y-5'>
						{/* Github Icon */}
						<IconClickableWithAnimation Icon={GithubIcon} href={'https://github.com/KamauAlex'} />
						{/* Linkedin icon */}
						<IconClickableWithAnimation
							Icon={LinkedinIcon}
							href={'https://www.linkedin.com/in/myprofessi0nalprofalex/'}
						/>
						{/* Instagram Icon */}
						...
						<IconClickableWithAnimation
							Icon={UpworkIcon}
							href={'https://www.upwork.com/freelancers/~019057a705d753c74b'}
						/>
					</div>
			...
			>
				<div className='flex flex-col space-y-24 justify-center items-center'>
					...
					<motion.div
						...
						className=''
					>
						<a href='mailto:njugunakamaau@gmail.com' target={'_blank'} rel='noreferrer'>
							<span className=' font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer'>
								njugunakamaau<span className='text-AAsecondary'>@</span>gmail
